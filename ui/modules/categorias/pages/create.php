    ...
    if ($_SERVER['REQUEST_METHOD'] === 'POST') {
        ...
        if (empty($nombre)) {
            ...
            if ($result['success']) {
                ...
                $error = $result['message'] ?? 'Error al crear la categoría';
            }
        }
    }
} catch (Exception $e) {
...
<div class="main-content">
    <div class="d-flex justify-content-between align-items-center mb-4">
        <h1><i class="fas fa-plus-circle me-2"></i>Nueva Categoría</h1>
        ...
        <div class="card-body">
            <form method="POST" id="categoryForm">
                ...
                <div class="mb-4">
                    ...
                    <input type="hidden" id="tipo" name="tipo" value="egreso">
                    ...
                    <button type="button" class="btn btn-outline-primary btn-lg w-100 p-4 rounded-custom shadow-sm" 
                        ...
                        <div class="d-flex align-items-center justify-content-center gap-3">
                            <div id="iconPreview" class="d-flex align-items-center justify-content-center" 
                                 style="width: 60px; height: 60px; background-color: #F1B10B; border-radius: 12px;">
                                <i class="fas fa-tag text-white" style="font-size: 1.8rem;"></i>
                            </div>
                            <div class="text-start">
                                <div class="fw-bold">Seleccionar icono</div>
                ...
                <div class="icon-grid" style="max-height: 400px; overflow-y: auto;">
                    <div class="row g-3">
                        <div class="col-3 col-md-2">
                            <button type="button" class="icon-select-btn w-100 p-3 rounded-custom border-0 bg-light shadow-sm selected" 
                                    data-icon="" 
