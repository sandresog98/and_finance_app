<?php
/**
 * AND FINANCE APP - Crear Categoría
 */

require_once __DIR__ . '/../models/CategoriaModel.php';

$pageTitle = 'Nueva Categoría';
$pageSubtitle = 'Crea una categoría personalizada';
                ...
                <form method="POST" id="formCategoria">
                    ...
                    <div class="mb-4">
                        ...
                        <input type="text" 
                               ...
                               placeholder="Ej: Comida rápida, Freelance..."
                               required
                               autofocus>
                    </div>
                            ...
                            <div class="mb-4">
                                ...
                                <button type="button" class="btn btn-outline-secondary w-100 selector-btn" 
                                    ...
                                    <div class="d-flex align-items-center" id="iconoSeleccionado">
                                        ...
                                        <span><?= $iconos[$data['icono']] ?? 'Etiqueta' ?></span>
                                    </div>
                                </button>
                            </div>
                        </div>
                    ...
                    <div class="mb-4">
                        ...
                        <div class="preview-categoria">
                            ...
                            <span class="fw-semibold" id="previewNombre"><?= $data['nombre'] ?: 'Nombre de categoría' ?></span>
                        </div>
                    </div>
                    ...
                    <div class="d-flex justify-content-between">
                        ...
                        <button type="submit" class="btn btn-primary">
                            <i class="bi bi-check-lg me-2"></i>Crear Categoría
                        </button>
                    </div>
                </form>
            </div>
