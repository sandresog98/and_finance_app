<?php
/**
 * AND FINANCE APP - Crear Gasto Recurrente
 */

require_once __DIR__ . '/../models/GastoRecurrenteModel.php';
require_once __DIR__ . '/../../cuentas/models/CuentaModel.php';

$pageTitle = 'Nuevo Gasto Recurrente';
$pageSubtitle = 'Programa un gasto o ingreso fijo';
...
$data = [
    ...
    'monto' => '',
    'frecuencia' => 'mensual',
    'dia_ejecucion' => (int)date('d'),
    'dias_ejecucion' => '15,30',
...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if (empty($errors)) {
        ...
        try {
            $gastoModel->create($data);
            setFlashMessage('success', 'Gasto recurrente creado correctamente');
            ob_end_clean();
        ...
        <div class="card fade-in-up">
            ...
            <div class="card-body">
                ...
                <form method="POST" id="formRecurrente">
                    ...
                    <!-- Día del mes (Modal) - para frecuencias que lo requieren -->
                    <div class="mb-4" id="diaEjecucionWrapper">
                        <label class="form-label">Día del mes</label>
                        <input type="hidden" name="dia_ejecucion" id="dia_ejecucion" value="<?= $data['dia_ejecucion'] ?>">
                        <button type="button" class="btn btn-outline-secondary w-100 selector-btn py-3" 
                            ...
                            <div class="d-flex align-items-center" id="diaSeleccionado">
                                <div class="selector-icon me-3" style="background-color: var(--secondary-green);">
                                    <span class="fw-bold"><?= $data['dia_ejecucion'] ?></span>
                                </div>
                                <div>
                                    <span class="fw-semibold">Día <?= $data['dia_ejecucion'] ?> de cada mes</span>
                                    <small class="d-block text-muted" id="notaDia31">
                                        <?= $data['dia_ejecucion'] > 28 ? 'En meses cortos se ajustará al último día disponible' : '' ?>
                                    </small>
                                </div>
                            </div>
                            <i class="bi bi-chevron-right ms-auto"></i>
                    ...
                    <!-- Día de la semana (Modal) - para frecuencia semanal -->
                    <div class="mb-4" id="diaSemanaWrapper" style="display: none;">
                        <label class="form-label">Día de la semana</label>
                        <input type="hidden" name="dia_semana" id="dia_semana" value="1">
                        <button type="button" class="btn btn-outline-secondary w-100 selector-btn py-3" 
                            ...
                            <div class="d-flex align-items-center" id="diaSemanaSeleccionado">
                                ...
                                <span class="fw-semibold">Lunes</span>
                            </div>
                            <i class="bi bi-chevron-right ms-auto"></i>
                        </button>
                    </div>
                    ...
                    <div class="mb-4" id="diasQuincenalesWrapper" style="display: none;">
                        ...
                        <input type="text" class="form-control" id="dias_ejecucion" name="dias_ejecucion" 
                               value="<?= htmlspecialchars($data['dias_ejecucion']) ?>"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                <div class="list-group list-group-flush">
                    ...
                    <button type="button" class="list-group-item list-group-item-action cuenta-option py-3"
                            data-id="<?= $cuenta['id'] ?>"
        ...
        <div class="modal-content">
            ...
            <div class="modal-body">
                ...
                <div class="row g-2">
                    <?php for ($i = 1; $i <= 31; $i++): ?>
                    <div class="col-auto">
                        <button type="button" class="btn dia-option <?= $data['dia_ejecucion'] == $i ? 'btn-primary' : 'btn-outline-secondary' ?>"
                                data-dia="<?= $i ?>"><?= $i ?></button>
                    </div>
                    <?php endfor; ?>
                </div>
...
document.addEventListener('DOMContentLoaded', function() {
    ...
    const notaDia31 = document.getElementById('notaDia31');
    ...
    function actualizarCategorias() {
        ...
        listaCategorias.innerHTML = categorias.map(cat => `
            <button type="button" class="list-group-item list-group-item-action categoria-option py-3"
    ...
    document.querySelectorAll('.dia-semana-option').forEach(btn => {
        btn.addEventListener('click', function() {
            ...
            diaEjecucionInput.value = dia; // También lo guardamos aquí
